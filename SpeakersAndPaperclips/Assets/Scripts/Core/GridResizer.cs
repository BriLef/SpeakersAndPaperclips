...
namespace Core
{
    ...
    public class GridResizer : MonoBehaviour
    {
        ...
        [Header("Options")] [Tooltip("Clamp the computed scale (0 disables clamping).")] [SerializeField]
        private float minScale = 0f;

        [SerializeField] private float maxScale = 0f;

        [Tooltip(
            "Recompute every frame (handy for responsive UIs). You can switch this off and call Refresh() manually.")]
        [SerializeField]
